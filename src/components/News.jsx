  ...
  render() {
    return (
      <>
          ...
          <div className="row">
            ...
            {!this.state.loading &&
              this.state?.articles.map((items, id) => {
                return (
                  <div className="col-md-4 col-sm-6 col-xs-12" key={items.id}>
                    <NewsItem
                      title={
        ...
        <div className="container mx-2 d-flex my-4 justify-content-center">
          <button
            disabled={this.state.pg <= 1}
            className="btn-md btn btn-dark mx-5 "
            onClick={this.handlePrevious}
          >
            &larr; Previous
          </button>
          <div className="bg-danger p-3 text-light rounded">
            {this.state.pg}
          </div>
          <button
            disabled={
